...
//			Boolean sendMail=commonUtil.sendMail(url,email);
//			if(sendMail) {
//				session.setAttribute("succMsg", "pls check your email. Password Reset link sent");
//				
//			}else {
//				session.setAttribute("errorMsg", "Something Wrong Server! Email not send");
//			}
//		}
//		
//		
...
//	}
	...
	public String showResetPassword(@RequestParam String token, HttpSession session, Model m) {
		...
		if(userByToken ==null) {
			m.addAttribute("msg","Yor link is invalide or expired!!");
			return "message";
		}
